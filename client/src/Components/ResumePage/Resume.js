...
import { Grid, Header, Item, Message } from "semantic-ui-react";
        ...
        <Grid.Column width={5}>
          ...
          <Message>
            ...
            <Message.List>
              ...
              <Message.Item>Git based source control</Message.Item>
              <Message.Item>Mocha</Message.Item>
            </Message.List>
          </Message>
          ...
          <Message>
            ...
            <Header as="h5" style={{ textAlign: "left" }}>
              <a href = "https://www.youracclaim.com/earner/earned/badge/df5c64f6-82d2-4553-bb12-f9b7e3878d3c" target = "_blank">Lambda School Academy of Computer Science and Web Development June
              2018 to April 2019 click to view more.</a>
            </Header>
            ...
            <Message.List>
              ...
              <Message.Item>
                Building and Integrating RESTFUL API’s
              </Message.Item>
            </Message.List>
          </Message>
        </Grid.Column>
        <Grid.Column width={11}>
          ...
          <Message style={{ textAlign: "left" }}>
            ...
            <Message style={{ border: "None" }}>
              <Message.Header>
                Symposium- March 2019 - April 2019
              </Message.Header>
              <Message.List>
                <Message.Item>
                ...
                <Message.Item>
                  ...
                  feature. I also implemented the functionaMessage.Itemty for
                  editing a profile.{" "}
                </Message.Item>
              </Message.List>
            </Message>
          ...
          <ul>
            <li>
              ...
              group featured 17 students. I also conduct code reviews and assist
              students with their assignments and projects from debugging to
              providing feedback on best practices.{" "}
              <a
