    ...
    promise
      ...
      .catch(err => {
        ...
        dispatch({
          ...
          error: `Unable to fetch blogs ${err}`
        });
      });
  };
};
...
export const fetchOneBlog = id => {
  ...
  return dispatch => {
    ...
    promise
      ...
      .catch(err => {
        dispatch({
          type: FETCH_ONE_BLOG_FAILED,
          error: `Unable to fetch blog with id ${id}, ${err}`
        });
      });
  };
};
    ...
    promise
      ...
      .catch(err => {
        dispatch({
          ...
          error: `Unable to edit the post with id ${id} ${err}`
        });
      });
  };
};
    ...
    promise
      ...
      .catch(err => {
        dispatch({
          ...
          error: `Unable to post the blog ${err}`
        });
      });
  };
};
    ...
    promise
      ...
      .catch(err => {
        dispatch({
          ...
          error: `Unable to delete the blog with id ${id} ${err}`
        });
      });
  };
};
