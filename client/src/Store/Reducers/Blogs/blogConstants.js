...
export const FETCH_ONE_BLOG_ATTEMPT = "FETCH_ONE_BLOG_ATTEMPT";
export const FETCH_ONE_BLOG_SUCCESS = "FETCH_ONE_BLOG_SUCCESS";
export const FETCH_ONE_BLOG_FAILED = "FETCH_ONE_BLOG_FAILED";