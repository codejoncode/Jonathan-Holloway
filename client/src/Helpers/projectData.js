...
export const projectData = [
    ...
    {title: "Sudoku", deployUrl: "https://codejoncode.github.io/Sudoku/", githubUrl: "https://github.com/codejoncode/Sudoku", description: "", technologies: "JavaScript React", image: sudoku},
    {plan: "https://trello.com/b/bRjoKRwO/gameoflife-jonathanjamelholloway", title: "Conway's Game of Life", deployUrl: "https://codejoncode.github.io/Conways-Life/", githubUrl: "https://github.com/codejoncode/Conways-Life", description: "", technologies: "React JavaScript algorithms", image: conwaysGame},
    ...
    {title: "Forex Landing Page", deployUrl: "https://codejoncode.github.io/forex_page/", githubUrl: "https://github.com/codejoncode/forex_page", description: "", technologies: "Design React", image: forexLandingPage},
    {title: "Lambda Times", deployUrl: "http://motionless-note.surge.sh/", githubUrl: "https://github.com/codejoncode/Sprint-Challenge-Lambda-Times-React", description: "React JavaScript", technologies: "React JavaScript", image: lambdaTimes},
    {title: "Simple Calendar", deployUrl: "http://lethal-juice.surge.sh/", githubUrl: "https://github.com/codejoncode/Calendar", description: "A simple calendar application to practice skills learned in week 7 of Lambda School. This was not school related but practice to gain mastery in the topics. The application will allow one to move the year or the month and get the creat dates aligned on the application. I honestly didn't finish this application as I had desires to add tasks to certain date.", technologies: "moment  React JavaScript", image: simpleCalendarApp},
    {title: "React Wars", deployUrl: "http://ruddy-throne.surge.sh/", githubUrl: "https://github.com/codejoncode/Sprint-Challenge-React-Wars", description: "This was a Sprint Challenge in which I had three hours to implement a solution to the problem. Please see the repo link. Fetching data and displaying as we saw fit.", technologies: "React JavaScript", image: ReactWars},
    {title: "Simple Calculator", deployUrl: "http://worried-snakes.surge.sh/", githubUrl: "https://github.com/codejoncode/React-UI-Components", description: "A simple calculator application used at the beginning of learning how to use React to build components. This is from the React UI Components section of Lambda School.", technologies: "React JavaScript", image: calculatorComponents},
    {title: "Social Card", deployUrl: "http://upbeat-son.surge.sh/", githubUrl: "https://github.com/codejoncode/React-UI-Components", description: "A social card used at the beginning of learning how to use React to build components. This is from the React UI Components section of Lambda School.", technologies: "React JavaScript", image: socialCard},
    {features: "ablilty to add to the list, ablility to delete from the list, ablility to set a timer, ability search through the list", title: "Todo List", deployUrl: "http://hard-to-find-power.surge.sh/", githubUrl: "https://github.com/codejoncode/React-Todo", description: "A simple to do list", technologies: "JavaScript React", image: simpleTodoList},
